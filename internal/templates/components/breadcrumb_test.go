...
func TestBreadcrumbCrumbs_KeyRoutes(t *testing.T) {
	cases := []struct {
		...
		{"soldiers-list", "/soldiers", []string{"Home", "Search/Quick View"}},
		{"soldier-detail", "/soldiers/42", []string{"Home", "Search/Quick View", "#42"}},
		{"soldier-tags", "/soldiers/42/tags", []string{"Home", "Search/Quick View", "#42", "Tags"}},
		{"soldiers-new", "/soldiers/new", []string{"Home", "Search/Quick View", "Add Person"}},
