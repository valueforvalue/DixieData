...
| `/research/recent` | `routebuilder.ResearchRecent()` | `research_picker.templ` (ResearchPickerRecent) | Recents-list fragment endpoint. Slice 2 ships the route + handler shape; slice 3 wires localStorage-driven IDs (issue #378 option C1). |
