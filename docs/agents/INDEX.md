...
| [`docs/agents/probe-clean.md`](probe-clean.md) | Build cleanup — AV / debugger / watcher stragglers after Windows builds. Load when `just probe-clean` fails or when designing the pre-build step. |
