...
- **App:** DixieData
- **Version:** `1.1.29` (issue #266 v{MAJOR}.{U}.{N} split; U=1 implicit for legacy v1.2.N releases, release counter N=29)
- **Schema version:** `68`
...
- **Keep Incoming** - overwrite local content but keep the local display ID
