...
#set page(
  ...
  footer: [#context [#text(size: 7pt, fill: luma(120))[#footer-text #h(0.4em) #emph[#codename] #h(1fr) #a.at("created_at", default: "") #h(1em) #a.at("updated_at", default: "") #h(1fr) Page #counter(page).display("1")]]],
)
